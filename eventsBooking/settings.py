...
SECRET_KEY = 'django-insecure-gy$u8ar*_kxf)%gc3!n1ln)8ol@zfaeabo^4$v=ml6sg_d+^3i'
...
ROOT_URLCONF = 'eventsBooking.urls'
...
WSGI_APPLICATION = 'eventsBooking.wsgi.application'
